...
#            self.Wx.append(uniform_weight(n_in,n_hidden))
#            self.Wh.append(ortho_weight(n_hidden))
#            self.bh.append(const_bias(n_hidden,0))
#            self.am.append(const_bias(n_hidden,1))
#            self.ax.append(const_bias(n_hidden,1))
#            self.ah.append(const_bias(n_hidden,1))
#        
...
#            p_t = []
#            for i in range(order):
#                preact = am[i]*T.dot(x_t,Wx[i])*T.dot(h_tm1,Wh[i]) \
#                        +ax[i]*T.dot(x_t,Wx[i]) \
#                        +ah[i]*T.dot(h_tm1,Wh[i]) \
#                        +bh[i]
#                h_t = h_t*act(preact)
#                p_t.append(preact)
